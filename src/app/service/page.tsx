...
export default async function Service() {
    ...
    return (
        <div className="w-full">
            <div className=" p-16 max-w-7xl mx-auto flex flex-wrap justify-evenly gap-10">
                <div className="card bg-base-100 h-[525px] lg:w-1/4 shadow-xl rounded-lg border-2 border-gray-500 hover:scale-105 duration-200 -z-20">
                    <figure>
                ...
                <div className="card bg-base-100 h-[525px] lg:w-1/4 shadow-xl rounded-lg border-2 border-gray-500 hover:scale-105 duration-200 -z-20">
                    ...
                    <div className="card-body">
                        <h2 className="card-title py-2 px-2 font-bold text-blue-900">Air of Rinjani </h2>
                        <p className="py-2 px-2 text-balance font-light">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Repudiandae sapiente in vel ullam ex illo pariatur assumenda cupiditate dolorem facilis est, perferendis ipsum eveniet ratione iure! Repudiandae perferendis expedita illum.</p>
                        <div className="card-actions text-center">
                ...
                <div className="card bg-base-100 h-[525px] lg:w-1/4 shadow-xl rounded-lg border-2 border-gray-500 hover:scale-105 duration-200 -z-20">
                    ...
                    <div className="card-body">
                        <h2 className="card-title py-2 px-2 font-bold text-blue-900">Air of Kerinci</h2>
                        <p className="py-2 px-2 text-balance font-light">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Repudiandae sapiente in vel ullam ex illo pariatur assumenda cupiditate dolorem facilis est, perferendis ipsum eveniet ratione iure! Repudiandae perferendis expedita illum.</p>
                        <div className="card-actions text-center">
